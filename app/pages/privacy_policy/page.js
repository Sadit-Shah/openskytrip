...
import privacycss from './privacy_policy.module.scss'
export default function PrivacyPolicy() {
    return (
        <div className={privacycss.container}>
            ...
            <p>
                openskytrips may update these terms of utilization for its website whenever without notification. By utilizing this site you are consenting to be bound by the then current form of these Terms and Conditions of Use.
            </p>
            <div className={privacycss.heading}>
                <span>
                    8. Governing Law
            ...
            <div className={privacycss.lists}>
                <ul>
                    <li><i className="fa-solid fa-arrow-right fa-beat-fade fa-2xl"></i>Your privacy is critical to us. Likewise, we have built up this Policy with the end goal you should see how we gather, utilize, impart and reveal and make utilization of individual data. The following blueprints our privacy policy.</li>
                    <li><i className="fa-solid fa-arrow-right fa-beat-fade fa-2xl"></i>Before or at the time of collecting personal information, we will identify the purposes for which information is being collected.</li>
                    <li><i className="fa-solid fa-arrow-right fa-beat-fade fa-2xl"></i>We will gather and utilization of individual data singularly with the target of satisfying those reasons indicated by us and for other good purposes, unless we get the assent of the individual concerned or as required by law.</li>
                    <li><i className="fa-solid fa-arrow-right fa-beat-fade fa-2xl"></i>We will just hold individual data the length of essential for the satisfaction of those reasons.</li>
                    <li><i className="fa-solid fa-arrow-right fa-beat-fade fa-2xl"></i>We will gather individual data by legal and reasonable means and, where fitting, with the information or assent of the individual concerned.</li>
                    <li><i className="fa-solid fa-arrow-right fa-beat-fade fa-2xl"></i>Personal information ought to be important to the reasons for which it is to be utilized, and, to the degree essential for those reasons, ought to be exact, finished, and updated.</li>
                    <li><i className="fa-solid fa-arrow-right fa-beat-fade fa-2xl"></i>We will protect individual data by security shields against misfortune or burglary, and also unapproved access, divulgence, duplicating, use or alteration.</li>
                    <li><i className="fa-solid fa-arrow-right fa-beat-fade fa-2xl"></i>We will promptly provide customers with access to our policies and procedures for the administration of individual data.</li>
                    <li><i className="fa-solid fa-arrow-right fa-beat-fade fa-2xl"></i>We are focused on leading our business as per these standards with a specific end goal to guarantee that the privacy of individual data is secure and maintained.</li>
                </ul>
            </div>
